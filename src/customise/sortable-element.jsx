...
export default function (ComposedComponent) {
  ...
  // let DropTarget = (ItemTypes.CARD, cardTarget, connect) => ({
    
  // })
const itemData = ItemTypes.CARD;

  let DropTarget = (itemData, cardTarget, connect) => ({
      connectDropTarget: connect.dropTarget(),
  })(Card)

  let DragSource;
  return DragSource = (itemData, cardSource, connect, monitor) => ({
